...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#d1ccaa48#;
   ...
   u00012 : constant Version_32 := 16#c40bf0df#;
   ...
   u00014 : constant Version_32 := 16#d845cfdc#;
   pragma Export (C, u00014, "system__secondary_stackS");
   u00015 : constant Version_32 := 16#04356d51#;
   pragma Export (C, u00015, "ada__exceptionsB");
   u00016 : constant Version_32 := 16#677117e5#;
   ...
   u00019 : constant Version_32 := 16#d01276af#;
   ...
   u00023 : constant Version_32 := 16#d2b991ce#;
   pragma Export (C, u00023, "system__exceptions_debugS");
   u00024 : constant Version_32 := 16#7597daaf#;
   pragma Export (C, u00024, "system__img_intS");
   u00025 : constant Version_32 := 16#2e691d75#;
   ...
   u00027 : constant Version_32 := 16#642d3d20#;
   ...
   u00029 : constant Version_32 := 16#2aab7611#;
   pragma Export (C, u00029, "system__traceback_entriesS");
   u00030 : constant Version_32 := 16#61e81064#;
   ...
   u00034 : constant Version_32 := 16#47e3d2a3#;
   ...
   u00036 : constant Version_32 := 16#b9ada65a#;
   pragma Export (C, u00036, "interfaces__cB");
   u00037 : constant Version_32 := 16#09d5a0e7#;
   pragma Export (C, u00037, "interfaces__cS");
   u00038 : constant Version_32 := 16#3007a9ef#;
   pragma Export (C, u00038, "system__parametersB");
   u00039 : constant Version_32 := 16#431962c1#;
   pragma Export (C, u00039, "system__parametersS");
   u00040 : constant Version_32 := 16#0978786d#;
   pragma Export (C, u00040, "system__bounded_stringsB");
   u00041 : constant Version_32 := 16#954ae884#;
   pragma Export (C, u00041, "system__bounded_stringsS");
   u00042 : constant Version_32 := 16#22b1fb99#;
   pragma Export (C, u00042, "system__crtlB");
   u00043 : constant Version_32 := 16#c12207f7#;
   pragma Export (C, u00043, "system__crtlS");
   u00044 : constant Version_32 := 16#71c7401b#;
   pragma Export (C, u00044, "system__dwarf_linesB");
   u00045 : constant Version_32 := 16#029d32b0#;
   pragma Export (C, u00045, "system__dwarf_linesS");
   u00046 : constant Version_32 := 16#5b4659fa#;
   pragma Export (C, u00046, "ada__charactersS");
   u00047 : constant Version_32 := 16#75913d83#;
   ...
   u00073 : constant Version_32 := 16#25d4b3b8#;
   ...
   u00075 : constant Version_32 := 16#d8f6eff3#;
   pragma Export (C, u00075, "system__atomic_primitivesS");
   u00076 : constant Version_32 := 16#14fb286b#;
   pragma Export (C, u00076, "system__case_utilB");
   u00077 : constant Version_32 := 16#3c4f28f7#;
   pragma Export (C, u00077, "system__case_utilS");
   u00078 : constant Version_32 := 16#8b956324#;
   pragma Export (C, u00078, "system__case_util_nssB");
   u00079 : constant Version_32 := 16#87d84db7#;
   pragma Export (C, u00079, "system__case_util_nssS");
   u00080 : constant Version_32 := 16#256dbbe5#;
   pragma Export (C, u00080, "system__stringsB");
   u00081 : constant Version_32 := 16#7935c985#;
   pragma Export (C, u00081, "system__stringsS");
   u00082 : constant Version_32 := 16#8d759e14#;
   pragma Export (C, u00082, "system__object_readerB");
   u00083 : constant Version_32 := 16#ee235c84#;
   pragma Export (C, u00083, "system__object_readerS");
   u00084 : constant Version_32 := 16#b14bacb0#;
   pragma Export (C, u00084, "system__val_lliS");
   u00085 : constant Version_32 := 16#7d4c7c5b#;
   pragma Export (C, u00085, "system__val_lluS");
   u00086 : constant Version_32 := 16#0d1904b9#;
   pragma Export (C, u00086, "system__val_utilB");
   u00087 : constant Version_32 := 16#0e1c2bbe#;
   ...
   u00089 : constant Version_32 := 16#0e2fa0fb#;
   ...
   u00101 : constant Version_32 := 16#25e8dc8b#;
   ...
   u00125 : constant Version_32 := 16#ecfa876a#;
   pragma Export (C, u00125, "interfaces__c_streamsS");
   u00126 : constant Version_32 := 16#a94e7662#;
   pragma Export (C, u00126, "system__file_ioB");
   u00127 : constant Version_32 := 16#84f89cdb#;
   pragma Export (C, u00127, "system__file_ioS");
   u00128 : constant Version_32 := 16#7598b591#;
   pragma Export (C, u00128, "ada__finalizationS");
   u00129 : constant Version_32 := 16#d00f339c#;
   pragma Export (C, u00129, "system__finalization_rootB");
   u00130 : constant Version_32 := 16#e8cbf749#;
   pragma Export (C, u00130, "system__finalization_rootS");
   u00131 : constant Version_32 := 16#8e328749#;
   pragma Export (C, u00131, "system__finalization_primitivesB");
   u00132 : constant Version_32 := 16#64e3a357#;
   pragma Export (C, u00132, "system__finalization_primitivesS");
   u00133 : constant Version_32 := 16#fae11091#;
   pragma Export (C, u00133, "system__os_locksS");
   u00134 : constant Version_32 := 16#e91b7be9#;
   pragma Export (C, u00134, "system__os_constantsS");
   u00135 : constant Version_32 := 16#880c7e1a#;
   pragma Export (C, u00135, "system__file_control_blockS");
   u00136 : constant Version_32 := 16#a56a70fa#;
   pragma Export (C, u00136, "system__memoryB");
   u00137 : constant Version_32 := 16#fa235587#;
